...
setwd("C:/Arquivos/Documents/PowerBI/Cap15")
getwd()
...
## ANALISE EXPLORATORIA, LIMPEZA E TRANSFORMAÇÃO
...
# Alterada a variavel dependente para o tipo factor
...
# Total de inadimplentes verus não-inadimplentes
table(dados_clientes$inadimplente)

# Porcentenagem entre classes
...
modelo_v2 <- randomForest(inadimplente ~ ., data = dados_treino)
modelo_v2
